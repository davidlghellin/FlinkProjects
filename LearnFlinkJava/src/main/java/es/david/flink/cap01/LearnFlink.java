...
public class LearnFlink {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple3<Long, String, String>> lines = env.readCsvFile("C:\\Users\\david.lgonzalez\\IdeaProjects\\JavaLearnFlink\\src\\main\\resources\\movies.csv")
                // ignora la cabecera
                .ignoreFirstLine()
        ...
        pelis.writeAsText("C:\\Users\\david.lgonzalez\\IdeaProjects\\JavaLearnFlink\\src\\main\\resources\\output.txt",
                FileSystem.WriteMode.OVERWRITE);
        filteredMovies.writeAsText("C:\\Users\\david.lgonzalez\\IdeaProjects\\JavaLearnFlink\\src\\main\\resources\\output.txt",
                FileSystem.WriteMode.OVERWRITE);
